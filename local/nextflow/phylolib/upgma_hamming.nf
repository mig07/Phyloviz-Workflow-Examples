...
process hamming {
    ...
    '''
    java -jar resources/jar/*.jar distance hamming --dataset=ml:resources/data/datasets/10.txt --out=symmetric:out.txt
    '''
}
...
process upgma {
    ...
    '''
    java -jar resources/jar/*.jar algorithm upgma --out=newick:tree.txt --matrix=symmetric:out.txt
    '''
}