...
default_args = {
    'owner'                 : 'airflow',
    'description'           : 'Trimmomatic -> Spades -> Abricate example pipeline',
...
with DAG('Trimmomatic-Spades-Abricate-DockerOperators', default_args=default_args, schedule_interval="5 * * * *", catchup=False) as dag:
