...
process hamming {
    ...
    '''
    java -jar /app.jar distance hamming --dataset=ml:resources/data/datasets/10.txt --out=symmetric:matrix.txt
    '''
}
...
process goeburst {
    ...
    '''
    java -jar /app.jar algorithm goeburst --out=newick:tree.txt --matrix=symmetric:matrix.txt
    '''
}
...
process lbrOptimization {
    ...
    '''
    java -jar /app.jar optimization lbr --tree=newick:tree.txt --dataset=ml:resources/data/datasets/10.txt --matrix=symmetric:matrix.txt --out=newick:out.txt
    '''
}
